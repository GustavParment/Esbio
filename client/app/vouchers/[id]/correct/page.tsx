...
export default function CorrectVoucherPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const response = await fetch(`${process.env.NEXT_PUBLIC_API_URL || "https://esbio-backend-587000007432.europe-north1.run.app/api/v1"}/vouchers/${voucherId}/correct-with-changes`, {
        method: "POST",
        credentials: "include",
        headers: {
